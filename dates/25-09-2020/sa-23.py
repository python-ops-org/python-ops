#python sa-23.py -e stage -k connector-2-250114-d261c3498843.json -p connector-2-250114 -a nik-12345656 -d "dp-9" -c gcp-test-1 -i 5
...
def create_service_account(projectid,accountid,displayname,keyfile,new_name,envi,idd):
	...
	ansible_cred(projectid,new_name,envi,idd)
...
def ansible_cred(proj,name,envi,idd):
...
create_service_account(args.project,args.account,args.display_name,args.keyname,args.name,args.env,args.id)

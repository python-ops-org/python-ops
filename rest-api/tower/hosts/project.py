#python inv.py -a project_list -u http://192.168.56.117 -t jge72IFPtqPvYsflypTkFQk79jgAyo
...
def users_list(addr,tok):
        ...
        r0 = requests.get("%s/api/v2/projects/"%(addr),headers=headers)
...
def main():
    ...
    if (args.a is not None) and (args.a in ["project_list"]):    
        if args.a == "add":
